...
import TreatmentValidationCards from '../components/TreatmentValidationCards';
import TreatmentFeaturesStrip from '../components/TreatmentFeaturesStrip';
import TreatmentCTAStrip from '../components/TreatmentCTAStrip';
...
export default function CleanClaimIntelligence() {
  ...
  return (
    <div className="w-full">
      ...
      <section id="validation-layers" className="py-16 bg-white">
        <div className="container mx-auto px-4">
      ...
      {/* Treatment-Wise Clean Claim Validation Section */}
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[#006B7D] mb-4">
                Treatment-Wise Clean Claim Validation
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Pre-configured checklists ensure every treatment type is clinically justified, documented, 
                and scheme-compliant before claim submission.
              </p>
            </div>

            {/* Treatment Cards Grid */}
            <TreatmentValidationCards />

            {/* How These Cards Work Strip */}
            <div className="mt-12">
              <TreatmentFeaturesStrip />
            </div>

            {/* CTA Strip */}
            <div className="mt-12">
              <TreatmentCTAStrip onRequestDemo={() => setShowDemoModal(true)} />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-center gap-3">
                ...
                <span className="text-gray-700 font-medium">+91-82-333-93-456</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <Dialog open={showDemoModal} onOpenChange={setShowDemoModal}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold text-[#006B7D]">
              Request a Demo
            </DialogTitle>
          </DialogHeader>
