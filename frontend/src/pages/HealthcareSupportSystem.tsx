  ...
  const handleInterestClick = (categoryTitle: string) => {
    switch (categoryTitle) {
      ...
      case 'NGOs & Community Support':
        navigate({ to: '/ngo-listing' });
        break;
      case 'Emergency & Ambulance':
        navigate({ to: '/ambulance-services' });
        break;
      default:
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-primary to-primary/80 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Join Our Healthcare Ecosystem?
          </h2>
          <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto">
            Connect with thousands of healthcare providers and become part of India's most comprehensive healthcare support network
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              size="lg" 
              variant="outline"
              onClick={() => navigate({ to: '/network-directory' })}
              className="bg-transparent border-2 border-white text-white hover:bg-white/10 min-h-[44px]"
            >
              Browse Network
            </Button>
          </div>
